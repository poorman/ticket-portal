    ...
    <AnimatedPage>
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-crane/10 mb-4">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          ...
          <select
            ...
            className="text-xs bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-1.5 text-gray-400 focus:outline-none focus:border-crane/30"
          >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      {result.responseSnippet && (
                        <div className="text-xs text-gray-500 bg-white/[0.03] rounded-lg px-3 py-2 border-l-2 border-crane/30">
